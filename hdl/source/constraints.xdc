...
#set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33     } [get_ports { spi_rtl_ss_io }]; #IO_L15P_T2_DQS_13 Sch=jb_p[1]
#set_property -dict { PACKAGE_PIN W8    IOSTANDARD LVCMOS33     } [get_ports { spi_rtl_sck_io }]; #IO_L15N_T2_DQS_13 Sch=jb_n[1]
#set_property -dict { PACKAGE_PIN U7    IOSTANDARD LVCMOS33     } [get_ports { spi_rtl_io0_io }]; #IO_L11P_T1_SRCC_13 Sch=jb_p[2]
#set_property -dict { PACKAGE_PIN V7    IOSTANDARD LVCMOS33     } [get_ports { spi_rtl_io1_io }]; #IO_L11N_T1_SRCC_13 Sch=jb_n[2]
...
#set_property -dict { PACKAGE_PIN W6    IOSTANDARD LVCMOS33     } [get_ports { driver_enable_tri_o }]; #IO_L22N_T3_13 Sch=jb_n[4]


##Pmod Header JC
set_property -dict {PACKAGE_PIN T11 IOSTANDARD LVCMOS33} [get_ports CAM_LLC]
#set_property -dict { PACKAGE_PIN W14   IOSTANDARD LVCMOS33     } [get_ports { uart_rtl_txd }]; #IO_L8P_T1_34 Sch=jc_p[3]
#set_property -dict { PACKAGE_PIN Y14   IOSTANDARD LVCMOS33     } [get_ports { uart_rtl_rxd }]; #IO_L8N_T1_34 Sch=jc_n[3]
